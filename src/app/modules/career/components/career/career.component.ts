  ...
  career = [
    {
      ...
      notes: [
        ...
        'Collaborated with a brand to create a PWA for a customer competition with a short deadline. Designed the application to be appealing for the user and to be easy to use. Implemented a system using Socket.io and Express.js to have multiple moderators review and approve submissions.',
        "Provided various software solutions for departments to improve productivity and efficiency. Utilized data from Microsoft's Office 365 and monday.com API's to create centralized office calendars and scheduling systems for rooms.",
      ],
    },
    {
